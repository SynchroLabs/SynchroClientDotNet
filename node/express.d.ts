...
declare module "express" {
   ...
   // Connect middleware
    ...
    export function cookieParser(options?:any): (req: ExpressServerRequest, res: ExpressServerResponse, next) =>void;
    export function cookieSession(options?:any): (req: ExpressServerRequest, res: ExpressServerResponse, next) =>void;
    export function query(options?:any): (req: ExpressServerRequest, res: ExpressServerResponse, next) =>void;
    export function json(options?:any): (req: ExpressServerRequest, res: ExpressServerResponse, next) =>void;
